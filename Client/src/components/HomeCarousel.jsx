...
function HomeCarousel() {
    ...
    return (
        ...
        <Slider {...settings}>
            ...
            <div>
                <h2 className='absolute w-full text-center top-[15vh] text-6xl font-semibold uppercase drop-shadow-[0_1.2px_1.2px_rgba(180,147,6,0.8)] text-secondary underline'>Výprava z pohodlí domova</h2>
                <img className='w-full max-h-[100vh]' src={landingPage2}></img>
            </div>
            <div>
                <h2 className='absolute w-full text-center top-[15vh] text-6xl font-semibold uppercase drop-shadow-[0_1.2px_1.2px_rgba(180,147,6,0.8)] text-secondary underline'>Vyber si přátele a vyraž !</h2>
