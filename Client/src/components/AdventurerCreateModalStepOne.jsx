...
function AdventurerCreateModalStepOne(props) {
    ...
    return (
        <div className="modal-box">
            ...
            <input type="text" value={props.adventurerState.secondName} onChange={(event) => props.setAdventurerState({...props.adventurerState, secondName: event.target.value})} placeholder="Příjmení" className="w-full mb-5 text-white border-primary active:border-secondary input input-bordered " />
