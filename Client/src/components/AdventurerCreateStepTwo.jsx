    ...
    return (
        <div className="modal-box w-[90%] h-[90vh] max-w-[90%]">
            ...
            <div className='flex justify-center w-full'>
                <h3 className='w-full px-5 text-xl font-bold text-center uppercase border-2 text-primary border-primary bg-secondary rounded-xl'>Dostupné atributy: {props.atributesState.free}</h3>
            </div>


            <div className='grid grid-cols-3 gap-5 mt-5'>
                <div className='grid items-center justify-center grid-cols-3 border-primary bg-secondary rounded-xl '>
                    ...
                    <p className='text-lg font-bold text-center text-primary' >Síla: {props.atributesState.sila}</p>
...
<h3 className='mt-10 text-2xl text-center uppercase border-2 text-primary border-primary bg-secondary rounded-xl'> Výbava</h3>
            <div className='grid grid-cols-3 gap-5 mt-5'>
